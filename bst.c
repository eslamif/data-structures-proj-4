...
/*
 ...
 pre:	val is not null
 */
struct Node *_addNode(struct Node *cur, TYPE val)  //video @ 9:45
{
	/*write this*/
	assert(val != 0);
...
/*----------------------------------------------------------------------------*/
int containsBSTree(struct BSTree *tree, TYPE val)  //video @ 5:43
{
	/*write this*/
	assert(tree != 0);
	assert(val != 0);
...
/*----------------------------------------------------------------------------*/
TYPE _leftMost(struct Node *cur)    //video @ 4:44
{
	/*write this*/
	assert(cur != 0);
	while(cur->left != 0)
 ...
 */
/*----------------------------------------------------------------------------*/
struct Node *_removeLeftMost(struct Node *cur)  //video @ 11:23
{
	/*write this*/
	assert(cur != 0);
	struct Node *temp;
 ...
 */
/*----------------------------------------------------------------------------*/
struct Node *_removeNode(struct Node *cur, TYPE val)    //video @ 11:23
{
